-- Fix Ranking Logic to show Past Data (Yesterday / Last Week)
-- This ensures the leaderboards are static for the completed period, rather than real-time for the current period.

-- 1. Whales (Spent Amount)
...
BEGIN
  ...
  WHERE 
    ...
    END
  GROUP BY u.id, u.name, au.raw_user_meta_data
  HAVING COUNT(*) >= 10 -- Minimum 10 draws
