...
-- 1. hex_to_decimal helper (used by play_gacha for deterministic randomness)
...
-- 2. play_gacha (gacha draw engine, search_path includes extensions for hmac)
...
-- 3. play_gacha_locked (concurrency guard wrapping play_gacha)
...
-- 4. create_delivery_order (warehouse → delivery request)
