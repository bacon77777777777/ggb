-- Update play_gacha to support points payment
...
BEGIN
  ...
  -- Delegate to play_ichiban with points flag
  RETURN public.play_ichiban(p_product_id, v_ticket_numbers, p_use_points);
END;
$$;
