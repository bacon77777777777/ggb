...
export const MENU_PATH_ORDER: Array<{ path: string; permission: string }> = [
  ...
  { path: '/lottery',            permission: 'lottery' },
  { path: '/lottery/settings',   permission: 'lottery_settings' },
  ...
  { path: '/settings/recycle',   permission: 'settings_recycle' },
  ...
  { path: '/recycle-inventory',  permission: 'recycle_inventory' },
