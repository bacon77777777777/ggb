  ...
  return (
    <div className="relative w-full h-full" style={{ touchAction: 'pan-y' }}>
      ...
      <div className="absolute inset-0">
        <Image
          src={asset("/images/gacha/mode2/main.webp")}
          alt="gacha machine"
          fill
      ...
      <div
        ...
        style={{
          ...
          width: '94.27%',
          height: '41.42%',
          WebkitMaskImage: `url(${asset('/images/gacha/mode2/box.svg')})`,
          WebkitMaskSize: '100% 100%',
          maskImage: `url(${asset('/images/gacha/mode2/box.svg')})`,
          maskSize: '100% 100%',
        }}
      >
        {eggs.map((egg) => (
      ...
      >
        <Image src={asset("/images/gacha/mode2/switch.webp")} alt="switch" fill className="object-contain" unoptimized />
      </motion.div>
