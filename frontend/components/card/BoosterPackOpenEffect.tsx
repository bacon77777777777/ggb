...
export default function BoosterPackOpenEffect({
  ...
  const renderFace = (extraStyle?: React.CSSProperties) => (
    ...
    >
      ...
      {/* Charge glow: light.svg outline glows gold, opacity grows with charge */}
      {charge > 0 && (
        <svg
          viewBox="0 0 384 557"
          style={{
