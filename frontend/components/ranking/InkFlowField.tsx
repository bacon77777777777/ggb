// Ink Flow Field — Originkit（老闆 2026-08-21 指定為排行榜全螢幕背景）
// WebGL2 流體模擬（advection / 壓力 / 渦度）canvas，WebGL1 half-float fallback。
// 用在排行榜時以 fixed inset-0 鋪滿視窗、pointer-events-none 當純背景；
// 手機 prefers-reduced-motion 由呼叫端決定要不要掛（見 app/ranking/page.tsx）。
"use client"
