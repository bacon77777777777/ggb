  ...
  try {
    ...
    const [machineRes, poolRes] = await Promise.all([
      supabase
        .from('slot_machines')
        .select(`*, slot_themes(
          id, name, image_url, machine_type, machine_sprite_url, machine_layout, event_slug,
      ...
      supabase
        ...
        .select(`
          ...
          product_prizes (id, name, level, image_url, recycle_value, remaining, products(type)),
