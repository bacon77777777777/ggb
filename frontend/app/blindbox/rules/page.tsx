...
const steps = [
  ...
  },
  {
    ...
    items: [
      {
        label: '前往我的倉庫',
        desc: '進入「個人中心 → 我的倉庫」選取商品後申請配送。倉庫提供 30 天免費寄存，逾期系統將自動分解品項並返還相應代幣，請務必在期限內申請配送。',
      },
    ],
  },
];
...
export default function BlindboxRulesPage() {
  ...
  const rules = [
    ...
    {
      label: '倉庫寄存',
      desc: '商品存入我的倉庫後提供 30 天免費寄存。第 31 天起，系統將自動分解未申請配送的品項並返還相應代幣至帳戶，請務必在期限內申請配送。',
    },
    {
      label: '免運條件',
    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 pb-16 pt-14">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 h-14 bg-white dark:bg-neutral-900 border-b border-neutral-100 dark:border-neutral-800">
        <div className="max-w-[960px] mx-auto h-full flex items-center px-2">
          ...
          <span className="flex-1 text-center text-[17px] font-black text-neutral-900 dark:text-white mr-8 md:mr-0">盒玩規則</span>
