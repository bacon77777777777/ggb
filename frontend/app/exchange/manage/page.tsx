    ...
    const run = async () => {
      ...
      try {
        ...
        const mappedOffers: ExchangeOffer[] = (offerRows || []).map((row: any) => {
          ...
          return {
            ...
            user: {
              ...
              avatar: user.avatar_url || asset('/images/avatar.webp'),
              trades: 0,
            },
            getting,
            giving,
        ...
        const mappedOrders: ExchangeOrder[] = (orderRows || []).map((row: any) => {
          ...
          const display = displayById.get(otherId) || { name: 'user', avatar_url: asset('/images/avatar.webp') };
                    ...
                    return (
                      ...
                      >
                        <div className="relative w-11 h-11 rounded-full overflow-hidden bg-neutral-100 dark:bg-neutral-800 shrink-0">
                          <Image src={o.avatar || asset('/images/avatar.webp')} alt={o.title} fill className="object-cover" />
                        </div>
