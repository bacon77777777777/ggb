      ...
      <div className="max-w-3xl mx-auto pt-4 md:pt-8 px-4">
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-100 dark:border-neutral-800 divide-y divide-neutral-100 dark:divide-neutral-800">
          ...
          <section className="p-5">
            <h2 className="text-sm font-black text-neutral-900 dark:text-white mb-3">一、會員資格</h2>
          ...
          <section className="p-5">
            <h2 className="text-sm font-black text-neutral-900 dark:text-white mb-3">二、代幣制度與付款</h2>
            <ul className="space-y-2 text-[13px] text-neutral-500 dark:text-neutral-400 leading-relaxed">
          ...
          <section className="p-5">
            <h2 className="text-sm font-black text-neutral-900 dark:text-white mb-3">三、抽獎服務</h2>
            <ul className="space-y-2 text-[13px] text-neutral-500 dark:text-neutral-400 leading-relaxed">
          ...
          <section className="p-5">
            <h2 className="text-sm font-black text-neutral-900 dark:text-white mb-3">四、倉庫寄存與自動分解</h2>
            <ul className="space-y-2 text-[13px] text-neutral-500 dark:text-neutral-400 leading-relaxed">
          ...
          <section className="p-5">
            <h2 className="text-sm font-black text-neutral-900 dark:text-white mb-3">五、禁止行為</h2>
            <ul className="space-y-2 text-[13px] text-neutral-500 dark:text-neutral-400 leading-relaxed">
          ...
          <section className="p-5">
            <h2 className="text-sm font-black text-neutral-900 dark:text-white mb-3">六、帳號暫停與終止</h2>
            <ul className="space-y-2 text-[13px] text-neutral-500 dark:text-neutral-400 leading-relaxed">
          ...
          <section className="p-5">
            <h2 className="text-sm font-black text-neutral-900 dark:text-white mb-3">七、免責聲明</h2>
            <ul className="space-y-2 text-[13px] text-neutral-500 dark:text-neutral-400 leading-relaxed">
          ...
          <section className="p-5">
            <h2 className="text-sm font-black text-neutral-900 dark:text-white mb-3">八、適用法律與爭議解決</h2>
