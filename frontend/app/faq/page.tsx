...
const faqs: { category: string; items: Faq[] }[] = [
  {
    ...
    items: [
      {
        q: '第一次來，要怎麼開始？',
        a: <>註冊登入之後，先到<L href="/topup">儲值</L>買代幣，再挑一檔喜歡的商品按下去就開始了。代幣沒有最低儲值金額，想先小額試試看也可以。</>,
      },
      {
        q: '有哪些玩法？',
        a: <>一番賞、轉蛋、盒玩、抽卡、自製賞。另外還有<L href="/challenge">挑戰機台</L>、每日<L href="/mission">簽到</L>與任務。首頁上方的分類頁籤就是目前有開放的玩法，沒開放的不會顯示。</>,
      },
      {
        q: '代幣是什麼？跟積分一樣嗎？',
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: '機率在哪裡看？',
        a: <>商品頁的獎品列表就是。每個獎項旁邊會顯示總數與剩餘數，剩餘數會隨著被抽走即時減少。</>,
      },
      {
        q: '抽完可以反悔嗎？',
