...
export const MALL_SHELL = `
  ...
  <nav class="tabbar" role="tablist">
    ...
    <button role="tab" data-tab="official" aria-selected="false"><svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M3 9l1.5-5h15L21 9M4.5 9v11h15V9M4.5 9h15"/><path d="M9.5 20v-6h5v6"/></svg>官方</button>
    <button role="tab" data-tab="reels" aria-selected="false"><svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="3.5" y="4" width="17" height="16" rx="3"/><path d="M10 9.2v5.6l4.6-2.8z"/></svg>短影音</button>
