    ...
    <div className="min-h-screen bg-[#F5F5F5] dark:bg-neutral-950 pb-20">
      <div className="max-w-3xl mx-auto pt-4 md:pt-8 px-4">
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-xl border border-neutral-100 dark:border-neutral-800 divide-y divide-neutral-100 dark:divide-neutral-800">
          ...
          <section className="p-6">
            <h2 className="text-base font-black text-neutral-900 dark:text-white mb-3">三、倉庫商品出貨</h2>
            <ul className="space-y-2 text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed">
          ...
          <section className="p-6">
            <h2 className="text-base font-black text-neutral-900 dark:text-white mb-3">四、實體商品問題</h2>
            ...
            <ul className="space-y-2 text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed mb-3">
            ...
            <p className="text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed mb-2 font-bold text-neutral-700 dark:text-neutral-300">申請時需提供：</p>
            <ul className="space-y-1 text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed">
              <li>① 訂單編號</li>
          ...
          <section className="p-6">
            <h2 className="text-base font-black text-neutral-900 dark:text-white mb-3">五、不適用退換之情況</h2>
            <ul className="space-y-2 text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed">
          ...
          <section className="p-6">
            <h2 className="text-base font-black text-neutral-900 dark:text-white mb-3">六、異常補償方式</h2>
